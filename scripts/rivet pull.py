...
file_path = os.path.join(current_dir, "..", "data", "rivet_test", "W27_glass_cgy_latmid.is_tens_RawData", "Specimen_RawData_6.csv")
...
plt.savefig(f"results/rivet_test/W27_glass_cgy_latmid/{file_name}_force_displacement.png", dpi=300)
